...
//		System.out.println("\n");
		...
		String user_Name = (String)session.selectOne("UserMapper01.findUserId", user);
		System.out.println(":: 4. findUserId(SELECT)  ? "+user_Name ); //장보고
		System.out.println("\n");
